    ...
    Tables: {
      action_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_action_items_tenant"
            columns: ["tenant_id"]
            isOneToOne: false
      ...
      app_insights: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_app_insights_tenant"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      collection_products: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_collection_products_tenant"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      collection_shares: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_collection_shares_tenant"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      collections: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_collections_tenant"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      cross_sells: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_cross_sells_tenant"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      customer_projects: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_customer_projects_tenant"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      product_alternatives: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_product_alternatives_tenant"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      upload_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_upload_history_tenant"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      user_access_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_user_access_logs_tenant"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      user_column_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_user_column_settings_tenant"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      user_dashboard_settings: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_user_dashboard_settings_tenant"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      user_notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_user_notifications_tenant"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      user_preferences: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_user_preferences_tenant"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      user_project_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_user_project_history_tenant"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
